    ...
    <fieldset>
        ...
        <?php
           ...
           /* echo $this->Html->tableCells(
                [
                    $this->Form->input('username',['label'=>['class'=>'col-xs-2']])
                    ],
                [
                    $this->Form->input('email',['label'=>['class'=>'col-xs-2']])
                    ],
                [
                    $this->Form->input('old_password', ['type'=>'password', 'label'=>['class'=>'col-xs-2']])
                    ],
                [
                    $this->Form->input('new_password', ['type'=>'password','label'=>['class'=>'col-xs-2']])
                    ],
                [
                    $this->Form->input('role', ['label'=>['class'=>'col-xs-2'],'options'=>['Admin'=>'Admin','User'=>'User']])
                    ]
