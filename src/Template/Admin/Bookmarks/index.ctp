...
<div class="bookmarks index col-lg-9 col-md-8 columns content">
    <h3><?= __('Bookmarks') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $bookmark['user_id'] ? $this->Html->link($bookmark['Users']['email'], ['controller' => 'Users', 'action' => 'view', $bookmark['Users']['id']]) : '' ?></td>
